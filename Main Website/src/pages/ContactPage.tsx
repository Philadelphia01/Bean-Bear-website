              ...
              <div className="space-y-6">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Sandton City, Johannesburg, South Africa</p>
                  </div>
                </div>
      ...
      <section className="py-16 bg-dark-light">
        <div className="container">
          ...
          <div className="bg-dark p-2 rounded-lg">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14331.381866384703!2d28.0495119!3d-26.1039627!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1e95732d7abaa2bb%3A0x6e3b5ac49f8d784b!2sSandton%20City!5e0!3m2!1sen!2sza!4v1761039003365!5m2!1sen!2sza" 
              width="100%" 
              height="450" 
              style={{ border: 0 }} 
              allowFullScreen 
